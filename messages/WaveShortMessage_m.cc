//
// Generated file, do not edit! Created by nedtool 5.2 from veins/modules/messages/WaveShortMessage.msg.
//
...
int WaveShortMessage::getDestAddress() const
{
    return this->destAddress;
}

void WaveShortMessage::setDestAddress(int destAddress)
{
...
std::string WaveShortMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: return long2string(pp->getDestAddress());
...
bool WaveShortMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 9: pp->setDestAddress(string2long(value)); return true;
